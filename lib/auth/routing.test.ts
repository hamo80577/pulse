...
describe("auth routing", () => {
  ...
  it("allows Admin and Super Admin access to admin route families", () => {
    ...
    expect(canAccessPath("SUPER_ADMIN", "/admin/workforce")).toBe(true);
    ...
    expect(canAccessPath("ADMIN", "/admin/workforce")).toBe(true);
    expect(canAccessPath("ADMIN", "/admin/settings")).toBe(true);
    expect(canAccessPath("ADMIN", "/super-admin")).toBe(false);
    expect(canAccessPath("PICKER", "/admin/workforce")).toBe(false);
    expect(canAccessPath("CHAMP", "/admin/workforce")).toBe(false);
